 ...
 */
export const makeConnection = (conn: DuckDBConnection): Connection => {
  /**
 ...
 */
export const makeTransactionConnection = (conn: DuckDBConnection): Connection => {
  const base = makeConnection(conn)
