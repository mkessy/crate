...
// Client exports
export { DuckDbClient, layer, make } from "./client.js"

// Type exports
export type { DuckDbClient as DuckDbClientInterface, DuckDbClientConfig, DuckDbCustom, TypeId } from "./types.js"

// Fragment constructor exports
export { json, list, struct } from "./fragments.js"

// Compiler exports (for advanced use)
export { defaultTransforms, makeCompiler } from "./compiler.js"
